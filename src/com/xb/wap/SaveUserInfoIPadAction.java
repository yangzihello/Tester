 ...
 *
 */
public class SaveUserInfoIPadAction extends HttpServlet {
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if(flag && phone.matches("^\\d{11}$")){
			...
			try {
				...
				ptst.executeUpdate();
				request.getRequestDispatcher("result-ipad-success.jsp").forward(request, response);
		...
		request.getRequestDispatcher("result-ipad.jsp").forward(request, response);
	}
